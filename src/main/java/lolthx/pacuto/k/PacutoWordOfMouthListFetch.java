...
import lolthx.pacuto.bean.PacutoWordOfMouthPostBean;

public class PacutoWordOfMouthListFetch extends DistributedParser {
	...
	public static void main(String args[]){
		new PacutoWordOfMouthListFetch().run();
	}
