...
public class WeiboConcernUserTask extends Producer {
	...
	protected int parse() throws Exception {
		if(!StringUtils.isNumeric(this.uid)){
			this.newid = getUid(this.uid);
			Thread.sleep(15000);
		}
...
//					return Integer.parseInt(pageStr);
	...
	private String getUid(String uid2) throws IOException, InterruptedException {
		String uid = null;

		Document doc = WeiboFetcher.cnFetcher.fetch(buildUserUrl(uid2));
	...
	protected String buildUrl(int pageNum) throws Exception {
		return MessageFormat.format(WEIBO_USER_FOLLOWS_URL_TEMPLATE, newid,
