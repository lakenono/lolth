...
public class BaiduPostDetailFetch extends DistributedParser {

	@Override
	public String getQueueName() {
		return "baidu_post_detail";
	}
	...
	public void parse(String result, Task task) throws Exception {
		...
		BaiduPostBean post = null;
		
		post = new BaiduPostBean();
		...
		Thread.sleep(2000);
		String userhtml = GlobalComponents.fetcher.fetch(userBean.getUrl());
	...
	private void parseUserBean(Document doc, BaiduPostUserBean user) {
		String name = null;
		String posts = null;
		String postAge = null;
