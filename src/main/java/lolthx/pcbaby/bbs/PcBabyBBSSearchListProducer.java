...
public class PcBabyBBSSearchListProducer extends Producer {

	private static final String PCBABY_BBS_URL = "http://ks.pcbaby.com.cn/kids_bbs.shtml?q={0}&menu&pageNo={1}";
	
	private String keyword;

	public PcBabyBBSSearchListProducer(String projectName, String keyword) {
		super(projectName);
	...
	public static void main(String[] args) {
		...
		try {
			new PcBabyBBSSearchListProducer(projectName,keyword).run();
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
