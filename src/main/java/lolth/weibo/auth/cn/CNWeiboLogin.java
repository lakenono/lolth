 ...
 *
 */
public class CNWeiboLogin implements WeiboLogin {
	...
	public CNWeiboLogin(String user, String password) {
		this.user = user;
	...
	public Map<String, String> login() throws Exception {
		...
		Map<String, String> loginParams = getLoginParams(loginPageContent);
	...
	// 解析登录地址，登录提交表单参数
	private Map<String, String> getLoginParams(byte[] loginPageContent) throws IOException {
